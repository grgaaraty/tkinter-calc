...
def handle_button_click(clicked_button_text):
    ...
    if clicked_button_text == "=":
        try:
            # Replacing symbols with operators
            ...
            #if error present prints "एरोर छ" i.e error in Nepali
        except Exception as e:
            result_var.set("एरोर छ")
            # Clear the entry
    elif clicked_button_text == "C": 
        result_var.set("") #reset entry
...
result_entry = ttk.Entry(root, textvariable=result_var, font=("Arial", 45), justify="right",)
...
style.configure("TButton", font=("Arial",30 ), width=10, height=40)
